...
const Login: React.FC = () => {
  ...
  return <AuthCard title="Welcome back" description="Sign in to your account to continue" footer={<p className="text-center text-sm text-muted-foreground w-full">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Button type="submit" className="w-full bg-crypto-blue hover:bg-crypto-blue/90" disabled={isLoading}>
