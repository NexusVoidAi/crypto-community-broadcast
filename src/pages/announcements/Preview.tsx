...
import { ArrowLeft, CreditCard, Send, Check, Hash, MessageSquare, Loader2 } from 'lucide-react';
...
const Preview: React.FC = () => {
  ...
  const handlePayment = async () => {
    if (!announcement || !payment) return;
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between font-bold">
                    <span>Total</span>
                    <span className="text-crypto-green">${payment.amount} {payment.currency}</span>
                  </div>
                </div>
